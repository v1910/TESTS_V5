    ...
    console.log('ShowCurrentTest: handleChange:  arr_state_test=',arr_state_test);             
        ...
        dispatch({type: 'ShowCurrentTest_handleChange',  
                  payload: {
                      ...
                      state_tests:          arr_state_test_new,
...
//    console.log('ShowCurrentTest:------------- X_setInterval=',X_setInterval); 
    ...
    let  arr_state_test = Array(count_questions_test); // state of every question: true - curent question. false
    let  arr_state_green_red = Array(count_questions_test); // state of every question: green, 
